/**
 * Minimal SHA-256 for UTF-8 strings → lowercase hex (no Node `crypto` / no npm deps).
 * Used where `@p2p/shared` is bundled for the browser or Next.js server chunks.
 */
...
/** Full 64-char lowercase hex SHA-256 of UTF-8 `message`. */
