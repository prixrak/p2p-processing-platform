...
export class PayoutInternalController {
  ...
  @ApiOperation({ summary: 'List Pay-Out orders for the trader' })
  ...
  @ApiOperation({ summary: 'Admin assigns a payout order to a trader' })
  ...
  @Roles(UserRole.TRADER)
  @ApiOperation({ summary: 'Trader takes order into processing' })
  async traderTakeOrder(
    @CurrentUser('traderId') traderId: string,
    @Param('orderId', ParseUUIDPipe) orderId: string,
  ) {
    return this.payoutService.traderTakeOrder(traderId, orderId);
  }

  @Post('orders/:orderId/complete')
  @Roles(UserRole.TRADER)
  @ApiOperation({ summary: 'Trader marks order as completed' })
  ...
  @Roles(UserRole.TRADER)
  @ApiOperation({ summary: 'Trader marks order as failed' })
  async traderFail(
    @CurrentUser('traderId') traderId: string,
    @Param('orderId', ParseUUIDPipe) orderId: string,
